...
```{r}
# MAT =   ['Travel ID', 'Destination', 'Base price', 'Price with extra cost'],
...
MAT = data.frame(
  "Travel ID" = as.integer(c(154, 155, 156)),
  "Destination" = c("Rome", "Athens", "Warsaw"),
  "Base Price" = c(400, 300, 150),
  "Price with extra cost" = c('=SWITCH(B1,"Rome",10,"Atlanta","15","Green Bay",20,0)', '=ROUND(100*C2,0)', '=ROUND(100*C3,0)'),
  check.names = F
)
